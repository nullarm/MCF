      SUBROUTINE colloid_compute_rotation_acceleration(this,stat_info)
        !----------------------------------------------------
        ! Subroutine  : colloid_compute_rotation_acceleration
        !----------------------------------------------------
        !
           ...
           ELSE IF ( dim == 3 )  THEN
              ...
              DO i = 1, num
                 ...
                 CASE ( mcf_colloid_shape_star )
                    ...
                    PRINT *, "colloid_compute_rotation_acceleration: ", &
                 ...
                 CASE  DEFAULT
                    ...
                    PRINT *, "colloid_comput_rotation_acceleration: ", &
                         "No such shape in 3D !"
                    stat_info = -1
                    GOTO 9999
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_compute_rotation_acceleration
