      SUBROUTINE colloid_compute_translation_acceleration(this,stat_info)
        !----------------------------------------------------
        ! Subroutine  : colloid_compute_translation_acceleration
        !----------------------------------------------------
        !
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_compute_translation_acceleration
