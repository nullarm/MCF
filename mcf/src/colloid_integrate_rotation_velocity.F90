      SUBROUTINE colloid_integrate_rotation_velocity(this,&
           step,dt,stat_info)
        !----------------------------------------------------
        ! Subroutine  : colloid_integrate_rotation_velocity
        !----------------------------------------------------
        !
        ...
        IF ( this%rotate ) THEN
           ...
           CASE DEFAULT
              ...
              PRINT *, "colloid_integrate_rotation_velocity: ",&
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_integrate_rotation_velocity
