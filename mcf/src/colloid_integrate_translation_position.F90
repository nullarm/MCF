      SUBROUTINE colloid_integrate_translation_position(this,&
           step,dt,stat_info)
        !----------------------------------------------------
        ! Subroutine  : colloid_integrate_translation_position
        !----------------------------------------------------
        !
        ...
        IF( this%translate ) THEN
           ...
           CASE DEFAULT
              ...
              PRINT *, "colloid_integrate_translation_position: ",&
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_integrate_translation_position
