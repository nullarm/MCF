      SUBROUTINE colloid_integrate_translation_velocity(this,&
           step,dt,stat_info)
        !----------------------------------------------------
        ! Subroutine  : colloid_integrate_translation_velocity
        !----------------------------------------------------
        !
        ...
        IF ( this%translate ) THEN
           ...
           CASE DEFAULT
              ...
              PRINT *, "colloid_integrate_translation_velocity: ",&
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_integrate_translation_velocity
