	...
	! Arguments.
        ...
        IF( num_species > 1 .AND. num_colloid > 0 ) THEN 
           ...
           WRITE(cbuf, '(A,I3)') 'coll_sub_time_step = ', &
                coll_sub_time_step
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub)  TRIM(cbuf)
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub) ' '
          
           WRITE(cbuf, '(A,I3)') 'coll_implicit_pair_num_sweep = ', &
                coll_implicit_pair_num_sweep
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub)  TRIM(cbuf)
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub) ' '
           
           WRITE(cbuf, '(A,I3)') 'coll_implicit_pair_sweep_adaptive = ', &
                coll_implicit_pair_sweep_adaptive
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub)  TRIM(cbuf)
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub) ' '
           ...
           WRITE(cbuf, '(A,I3)') 'coll_implicit_pair_sweep_max = ', coll_implicit_pair_sweep_max
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub)  TRIM(cbuf)
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub) ' '
   
           WRITE(cbuf, '(A,I3)') 'coll_explicit_sub_time_step   = ', coll_explicit_sub_time_step
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub)  TRIM(cbuf)
           WRITE(UNIT=this%restart_physics_unit,FMT='(A)',IOSTAT=stat_info_sub) ' '
