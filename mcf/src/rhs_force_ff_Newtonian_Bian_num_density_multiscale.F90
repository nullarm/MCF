...
!----------------------------------------------------------------
      SUBROUTINE rhs_force_ff_Newtonian_Bian_num_density_multiscale(this,&
           xi,xj,dij,vi,vj,numi,numj, pi,pj,&
           mi,mj,w,gradw,fi,fj,auij,stat_info)
        !----------------------------------------------------
        ! Subroutine : rhs_force_ff_Newtonian_Bian
        !----------------------------------------------------
        !
	...
	! per unit mass (from pressure).
  	!----------------------------------------------------
        ...
        f_c = ( pi*mj/mi/(numi**2.0_MK) +  pj*mi/mj/(numj**2.0_MK)) * gradw
...
9999    CONTINUE
      ...
      END SUBROUTINE rhs_force_ff_Newtonian_Bian_num_density_multiscale
