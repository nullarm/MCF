...
#include "config.h"
      ...
      MODULE ppm_module_map_field_global
         ...
         INTEGER, DIMENSION(:  ), POINTER :: irecvfromsub=>null(),irecvtosub=>null()
         INTEGER, DIMENSION(:,:), POINTER :: irecvblkstart=>null(),irecvblksize=>null()
...
#include "ppm_map_field_global.F90"
